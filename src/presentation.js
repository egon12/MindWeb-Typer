...
function getLocal(id) {
    ...
    if (options.title) {
        document.getElementById('slide-title').innerHTML = options.title;
    } else {
        document.getElementById('slide-title').innerHTML = "Next";
    }
}
...
var l = document.getElementById('input-form-local');
...
document.getElementById('input-form-content').onchange = function(e) {
    saveLocal(l.value);
    processInput();
};
...
if (!document.getElementById('input-form-options').value) {
